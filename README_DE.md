...
>
> **Windows-Testbuild (offen):** Branch [`windows-wasapi-fix`](https://github.com/knoelliX/NativMix/tree/windows-wasapi-fix) — Other Apps, Mute-Zuverlässigkeit, App-Namen (z. B. RE-KORD) und Soft-Apply bei neuen Sessions (kein Linux-Reflex-Mute; vermeidet YouTube-Pause/Resume-Rampe). **Aktuellen Test-Installer laden:** [NativMix-1.0.19-Setup-windows-wasapi-fix](https://github.com/knoellix/NativMix/actions/runs/35869580575/artifacts/10754397851) (Actions-Artifact). Kein Release-Tag — **jeder darf testen und Feedback geben**, auch Kleinigkeiten. Der Maintainer nutzt Windows nicht täglich, deshalb helfen eure Berichte besonders. Neuere Builds: [Build Windows Installer](https://github.com/knoelliX/NativMix/actions/workflows/build-windows.yml) (manuell auf dem Branch).
